...
class SolverOptions:
    ...
    # === Angle update === # Update G matrix for case with s(t) (rotation of ferromagnetic field), if s rotates on fixed angle
    update_G_angle_threshold: float = 0.05  # рад (~2.9°)

    # === Verification ===
    check_residual: bool = False # Check Poisson residual
    check_energy: bool = False # Check GL energy
    check_conservation: bool = False # Check conservation of supercurrent
    ...
    log_level: str = "INFO"  # DEBUG, INFO, WARNING, ERROR, CRITICA
